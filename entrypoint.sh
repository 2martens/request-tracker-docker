...
envsubst '\$WEB_BASE_URL \$MAIL_HOST \$MAIL_FETCH_LOGIN \$MAIL_FETCH_PASSWORD \$MAIL_FETCH_FOLDER \$MAIL_FETCH_COMMENT_FOLDER \$OWNER_EMAIL' < /tmp/fetchmailrc > /etc/fetchmailrc
